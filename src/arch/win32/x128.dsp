...
USERDEP__RESC1="resc128.rc"	"res.rc"	"resacia.rc"	"reside64.rc"	"resreu.rc"	"resgeoram.rc"	"resramcart.rc"	"resmmc64.rc"	"resrs232user.rc"	"ressid.rc"	"resvicii.rc"	"resdrivec128.rc"	"resdigimax.rc"	"resmouse.rc"	"restfe.rc"	
# Begin Custom Build
InputPath=.\resc128.rc

"resc128cat.rc" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy /b resc128.rc + res.rc + resacia.rc + reside64.rc + resreu.rc + resgeoram.rc + resramcart.rc + resmmc64.rc + resrs232user.rc + ressid.rc + resvicii.rc + resdrivec128.rc + resdigimax.rc + resmouse.rc + restfe.rc resc128cat.rc /b
