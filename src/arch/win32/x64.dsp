...
# ADD CPP /nologo /W3 /GX /Z7 /Od /I ".\msvc" /I ".\\" /I "..\..\\" /I "..\..\drive" /I "..\..\vdrive" /I "..\..\monitor" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /FR /YX /FD /c
...
USERDEP__RESC6="resc64.rc"	"res.rc"	"resacia.rc"	"resdrivec64.rc"	"reside64.rc"	"resreu.rc"	"resgeoram.rc"	"resramcart.rc"	"resplus256k.rc"	"resplus60k.rc"	"resc64_256k.rc"	"resmmc64.rc"	"ressid.rc"	"resvicii.rc"	"resdigimax.rc"	"resmouse.rc"	"restfe.rc"	
# Begin Custom Build
InputPath=.\resc64.rc

"resc64cat.rc" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy /b resc64.rc + res.rc + resacia.rc + resdrivec64.rc + reside64.rc + resreu.rc + resgeoram.rc + resramcart.rc + resplus256k.rc + resplus60k.rc + resc64_256k.rc + resmmc64.rc + resrs232user.rc + ressid.rc + resvicii.rc + resdigimax.rc + resmouse.rc + restfe.rc resc64cat.rc /b
